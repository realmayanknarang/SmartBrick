...
export const NAV_ITEMS = [
  ...
  { icon: <SitesIcon />,       label: 'Sites',          path: '/dashboard/sites', group: 'PROCUREMENT' },
  { icon: <VendorsIcon />,     label: 'Vendors',        path: '/dashboard/vendors', group: 'PROCUREMENT' },
  { icon: <ApprovalsIcon />,   label: 'Approvals',      path: '/dashboard/approvals', group: 'PROCUREMENT' },
  { icon: <PoolingIcon />,     label: 'Order Pooling',  path: '/dashboard/pooling', group: 'PROCUREMENT' },
  { icon: <AnalyticsIcon />,   label: 'Analytics',      path: '/dashboard/analytics', group: 'INSIGHTS' },
  { icon: <ForecastIcon />,    label: 'Forecasting',    path: '/dashboard/forecasting', group: 'INSIGHTS' },
  { icon: <AlertsIcon />,      label: 'Alerts',         path: '/dashboard/alerts', group: 'INSIGHTS' },
  { icon: <ReportsIcon />,     label: 'Reports',        path: '/dashboard/reports', group: 'INSIGHTS' },
  { icon: <ScannerIcon />,     label: 'Invoice OCR',    path: '/dashboard/invoice-scanner', group: 'OPERATIONS' },
  { icon: <WeatherNavIcon />,  label: 'Weather Alerts', path: '/dashboard/weather', group: 'OPERATIONS' },
  { icon: <MapNavIcon />,      label: 'Logistics',      path: '/dashboard/logistics', group: 'OPERATIONS' },
  { icon: <LeafNavIcon />,     label: 'Sustainability', path: '/dashboard/carbon', group: 'OPERATIONS' },
];
